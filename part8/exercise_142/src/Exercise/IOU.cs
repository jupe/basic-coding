  ...
  public class IOU
  {
   private Dictionary<string, int> dictionary;
    public IOU()
    {
     ...
     //You can use this to also lower the debt, but the total amount cannot be negative!
    ...
    // returns the amount owed to the person whose 
    //name is given as a parameter. If the person cannot be found, it returns 0.
